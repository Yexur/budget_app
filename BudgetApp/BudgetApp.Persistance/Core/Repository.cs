...
namespace BudgetApp.Persistance.Core
{
    ...
    where TEntity : class, IEntity
    {
        ...
        protected BudgetAppContext BudgetAppContext { get; private set; }

        public Repository(BudgetAppContext context)
        {
            BudgetAppContext = context;
            DbSet = BudgetAppContext.Set<TEntity>();
        }
        ...
        public virtual void Insert(TEntity entity)
        {
            ...
            else
            {
                ...
                BudgetAppContext.Entry(entity).State = EntityState.Modified;
            }
